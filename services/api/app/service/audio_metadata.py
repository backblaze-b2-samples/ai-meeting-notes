...
# and folds header names to lower-case kebab-case. The meeting pipeline
# uses these for the recording's duration only — diarization comes from
# the transcription provider, not from mutagen.
