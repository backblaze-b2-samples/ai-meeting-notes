      ...
      <div className="flex flex-col items-center gap-3">
        {isDragActive ? (
          <>
            ...
            <p className="text-base font-semibold">Drop meeting recordings here</p>
          </>
        ) : (
          <>
            ...
            <div>
              <p className="text-base font-semibold">
                Drag &amp; drop a meeting recording, or click to browse
              </p>
              <p className="text-xs text-muted-foreground mt-1 font-mono">
                .wav .mp3 .flac .ogg .m4a .aac .opus .mp4 .mov .webm &middot; up to 100 MB
              </p>
            </div>
          </>
        )}
